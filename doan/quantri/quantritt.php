...
<body>
    <header>
    <form action="../quantri/quantritt.php" method="post">
        ...
        <div class="container">
            <div class="menu-top">
                ...
                <div class="search">
                    <input type="text" name="tukhoa" id="search" placeholder="Thời gian đăng bài">
                ...
                <div class="box-user">
                   ...
                   $sotrang = ceil($tongtk / $soluong);
                    if(isset($_POST["tukhoa"]) && $_POST["tukhoa"] != ""){
                        ...
                        $sql = "SELECT * FROM tintuc WHERE Thoi_Gan LIKE  '%".$tukhoa."%'";
                        $rs = mysqli_query($conn, $sql);
                        }else{
                            $sql = "SELECT * FROM tintuc LIMIT $soluong OFFSET $vitritrongtrang ";
                            $rs = mysqli_query($conn, $sql);
                        }
                ...
                <div class="table">
                    <table>
                        ...
                        <tr> 
                            ...
                            <td class="file-img"><img src="<?php echo $rows['Hinh_Anh'];?>" alt=""></td>
                            <td><?php echo $rows['Ten_Tin']; ?></td>
                             <td><?php echo date("d/m/Y",strtotime($rows['Thoi_Gan'])); ?></td>
                            <td><?php echo $rows['Nd_Tin']; ?></td>
                            <td class="add"><a href="../quantritt/themtt.php"><i class="fa-solid fa-circle-plus"></i></a></td>
                            <td><a href="../quantritt/suatt.php?id=<?php echo $rows['Id_tintuc']; ?>"><i class="fa-solid fa-wrench"></i></a></td>
                            <td class="delete"><a href="../quantritt/xoatt.php?id=<?php echo $rows['Id_tintuc']; ?>" onclick="return confirm('Bạn thực sự muốn xóa !!!')"><i class="fa-solid fa-xmark"></i></a></td>
                        </tr>
                        <?php } ?>
                    </table>
                </div>
