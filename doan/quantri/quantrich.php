...
<body>
    <header>
        <form action="../quantri/quantrich.php?tukhoa=<?php echo $tukhoa ?>" method="post">
        <div class="container">
            <div class="menu-top">
                ...
                <div class="search">
                    <input type="text" name="tukhoa" id="search" placeholder="Tìm kiếm tên">
                ...
                <div class="box-user">
                    ...
                    $sqll = "SELECT * FROM hotro";
                    $tong = mysqli_query($conn, $sqll);
                   $tongtk = mysqli_num_rows($tong);
                   $sotrang = ceil($tongtk / $soluong);
                if(isset($_POST["tukhoa"]) && $tukhoa != ""){
                   
                    $sql = "SELECT * FROM hotro WHERE Ho_Ten LIKE '%".$tukhoa."%' ";
                    $rs = mysqli_query($conn, $sql);
                }else{
                    $sql = "SELECT * FROM hotro LIMIT $soluong OFFSET $vitritrongtrang";
                    $rs = mysqli_query($conn, $sql);
                }
                        echo $_SESSION["user"];
                ...
                <div class="table">
                    <table>
                        ...
                        <tr> 
                            ...
                            <td colspan="3"><?php echo $rows['Cau_Hoi'];?></td>
                            <td class="delete"><a href="../quantrich/xoach.php?id=<?php echo $rows['Id_Hotro']; ?>" onclick="return confirm('Bạn thực sự muốn xóa !!!')"><i class="fa-solid fa-xmark"></i></a></td>
                        </tr>
                        <?php } ?>
                    </table>
                </div>
