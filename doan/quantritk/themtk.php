 ...
 if (!isset($_SESSION["user"])) {
    ...
    if(isset($_POST["submit"]) && $_POST["username"] != '' && $_POST["password"] != '' && $_POST["repassword"] != ''){
        ...
        if($password != $repassword){
            echo "<h1>Mật khẩu không khớp !!!</h1>";    
        }else{
            ...
            if( mysqli_num_rows($old) > 0){
                ...
                $sql = "INSERT INTO login(Tai_khoan,Mat_khau,Ten_TS,Loai_Tk) VALUES ('$username', '$password','$name','$loaitk')";
...
">
            <div class="form-login-right">
                <form action="themtk.php" method="POST" role="form">
                    <div class="logo">
                    </div>
                    <div class="login-form">
                        ...
                        <div>
                            <br>
                            <p>Loại tài khoản:</p>
                            <input class="input" class="input" type="text" name="loaitk" id="password"
