    ...
    if(isset($_POST["submit"])){
        ...
        if($namts == '' && $dothi == '' && $kithi == ''){
            $loi = "Chưa nhập đủ thông tin !!!";
                ...
                $sql = "INSERT INTO phongthi(Doi_Thi,Ki_Thi) VALUES ($dothi,'$kithi')";
...
">
    <div class="form-login-right">
        <form action="../quantript/thempt.php" method="POST" role="form">
            <div class="logo">
            </div>
            <div class="login-form">
                ...
                <div>
                    <p>Đợt thi:</p>
                    <input class="input" class="input" type="name" name="dothi" id="name" placeholder="Nhập đợt thi" >
                    <span class="check-phone"></span>
                </div>
                <div>
                    <p>Kì thi:</p>
                    <input class="input" type="username" name="kithi" id="kithi" placeholder="Tên kì thi"  >
                    <span class="check-phone"></span>
