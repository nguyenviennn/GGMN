<?php
    ...
    $sqll = "SELECT * FROM hoso WHERE Dot_Thi = $show_date";
    $tong = mysqli_query($conn, $sqll);
   $tongtk = mysqli_num_rows($tong);
   $sotrang = ceil($tongtk / $soluong);   
    if(isset($_POST["tukhoa"]) && $tukhoa != ""){
        $sql_thongke = "SELECT * FROM hoso WHERE Dot_Thi = $show_date AND Ho_Ten LIKE '%".$tukhoa."%' ";
        $tk = mysqli_query($conn, $sql_thongke);
    }else{
        $sql_thongke = "SELECT * FROM hoso WHERE Dot_Thi = $show_date LIMIT $soluong OFFSET $vitritrongtrang";
        $tk = mysqli_query($conn, $sql_thongke);
    }
?>
        ...
        <div class="container">
            ...
            <table class="table">
                <div class="chucnang">
                    <div class="select">
                        ...
                        <div class="list-select">
                            ...
                            <!-- <div class="list1">
                                ...
                                <div class="list2">
                                    <p><a
                                            href="../thongke/thongkenam1.php?id=<?php echo $_GET['id'];?>&time=2022">2022</a>
                                    </p>
                                    <p><a
                                            href="../thongke/thongkenam1.php?id=<?php echo $_GET['id'];?>&time=2021">2021</a>
                                    </p>
                                    <p><a
                                            href="../thongke/thongkenam1.php?id=<?php echo $_GET['id'];?>&time=2020">2020</a>
                                    </p>
                                    <p><a
                                            href="../thongke/thongkenam1.php?id=<?php echo $_GET['id'];?>&time=2019">2019</a>
                                    </p>
                                </div>
                            </div> -->
                            <div class="list1">
                    ...
                    <form action="../thongke/thongke.php?id=<?php echo $_GET['id'];?>" method="post">
                        <div class="search">
