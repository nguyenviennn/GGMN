<?php
    ...
    $sqll = "SELECT * FROM hoso WHERE Dot_Thi";
    $tong = mysqli_query($conn, $sqll);
   $tongtk = mysqli_num_rows($tong);
   $sotrang = ceil($tongtk / $soluong);   
    if(isset($_POST["tukhoa"]) && $tukhoa != ""){
        $sql_thongke = "SELECT * FROM hoso WHERE Ho_Ten LIKE '%".$tukhoa."%' ";
        $tk = mysqli_query($conn, $sql_thongke);
    }else{
        $sql_thongke = "SELECT * FROM hoso LIMIT $soluong OFFSET $vitritrongtrang";
        $tk = mysqli_query($conn, $sql_thongke);
    }
                    ...
                    <div class="select">
                        ...
                        <div class="list-select">
                            ...
                            <p><a href="thongkedt1.php?id=<?php echo $_GET['id'];?>">Năm dự thi</a></p>
                                <div class="list2">
                                    <p><a href="../thongke/thongkedt.php?id=<?php echo $_GET['id'];?>&dt=2022">Năm 2022</a></p>
                                    <p><a href="../thongke/thongkedt.php?id=<?php echo $_GET['id'];?>&dt=2021">Năm 2021</a></p>
                                    <p><a href="../thongke/thongkedt.php?id=<?php echo $_GET['id'];?>&dt=2020">Năm 2020</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <form action="../thongke/thongkedt1.php?id=<?php echo $_GET['id'];?>&tukhoa=<?php echo $tukhoa ?>"
                        method="post">
                        <div class="search">
